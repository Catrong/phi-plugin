...
class Config {
     ...
     * @param {'renderScale'|'randerQuality'|'b19size'|'WordB19Img'|'WordSuggImg'|'cmdhead'|'GuessTipCd'|'GuessTipRecall'|'isGuild'|'LetterWinner'|'LetterGuessCd'|'LetterRevealCd'|'LetterTipCd'|'otherinfo'|'LetterNum'|'timeout'} style key值
    */
