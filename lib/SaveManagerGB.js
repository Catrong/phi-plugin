...
export default class SaveManagerGB {
    static baseUrl = "https://kviehlel.cloud.ap-sg.tapapis.com/1.1";
    static client = new HttpClient();
    static globalRequest = new HttpRequest.Builder()
        .header("X-LC-Id", "kviehleldgxsagpozb")
        .header("X-LC-Key", "tG9CTm0LDD736k9HMM9lBZrbeBGRmUkjSfNLDNib")
